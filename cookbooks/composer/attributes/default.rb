...
## Laravel Recipe Settings
default[:composer][:lvpath] = "/var/www"
default[:composer][:lvfolder] = ""
default[:composer][:lvversion] = ""
default[:composer][:lvuser] = "www-data"
default[:composer][:lvgroup] = "admin"
